...
public class CalculatorPanel extends javax.swing.JFrame {
    ...
    private static final String BASE_URI = "http://localhost:8080/Calculator/webresources/calc/";
    ...
    private void buttonEqualsMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_buttonEqualsMouseClicked
        ...
        Response resp = this.client.target(BASE_URI + op + "?n1=" + num1 + "&n2=" + num2).request(MediaType.TEXT_PLAIN).get();

        //Get just the body of the response (result of the operation)
        textScreen.setText(textScreen.getText() + " = " + resp.readEntity(String.class));
